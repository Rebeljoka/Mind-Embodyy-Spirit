...
MIDDLEWARE = [
    ...
    'django.middleware.cache.CacheMiddleware',  # Add cache middleware
...
# Cache configuration
CACHE_MIDDLEWARE_SECONDS = 15778463  # Cache pages for 6 months
CACHES = {
    'default': {
...
if DEBUG in ('True', True):
    # Local development: allow plain HTTP
